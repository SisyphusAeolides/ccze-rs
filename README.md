...
The package owns the standard `ccze` executable path and includes the native
analytics backend; no compiler is required at runtime. The supported release
and maintenance target is x86_64 Arch Linux and compatible Arch-based systems.
